...
public class LevelsUI : MonoBehaviour
{
    ...
    private Color _openedLevelButtonColor = Color.white;
    private Color32 _closedLevelButtonColor = new(100, 100, 100, 255);
    ...
    private void SetButtonsColor()
    {
        ...
        _level1Button.GetComponent<Image>().color = _openedLevelButtonColor;
        _level1Text.alpha = _maxAlpha;

        // Close Level 2 and Level 3
        _level2Button.GetComponent<Image>().color = _closedLevelButtonColor;
        _level2Text.alpha = _closedLevelTextAlpha;
        _level3Button.GetComponent<Image>().color = _closedLevelButtonColor;
        ...
        if(maxAchievedLevel > 1)
        {
            ...
            _level2Button.GetComponent<Image>().color = _openedLevelButtonColor;
            _level2Text.alpha = _maxAlpha;
            if(maxAchievedLevel > 2)
            {
                // Level 3 is achieved already.
                _level3Button.GetComponent<Image>().color = _openedLevelButtonColor;
